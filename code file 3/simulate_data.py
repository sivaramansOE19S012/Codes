...
t,u,v,r,x,y,psi,U,delta,DATA = zig_zag.activate('mariner',xt,ui,Req_simulation_time,t_rudderexecute,h,[39,39])
...
def Plot_simulated_Data1():
    ...
    plt.subplot(312)
    plt.plot(t[:len(t)-2],v[:len(v)-2],'m',label= "Sway Speed")
    plt.grid(b=0.1)
    plt.legend(loc="best")
