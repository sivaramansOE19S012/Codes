...
def graph_delta_all(u,v,r,rac):
    ...
    plt.title('Δu(k+1)-Δu(k), Δv(k+1)-Δv(k), Δr(k+1)-Δr(k)  plot')
...
def plot_surge_components_jsr2009(P):
    ...
    plt.xlabel('time in 2 seconds increment')
    plt.ylabel('Numerical Value of components except c5,c6,c8 & cb')
    plt.legend(loc = 'best')
    ...
    plt.xlabel('time in 2 seconds increment')
    plt.ylabel('Numerical Value of c6,c8 & c bias')
    plt.legend(loc = 'best')
