...
linear_svm1 = LinearSVR(C=1e08,fit_intercept = True, dual = False ,
...
linear_svm2_ramp =  LinearSVR(C=1e04,fit_intercept = True, dual = True ,
                        epsilon = 1e-6, loss = 'squared_epsilon_insensitive',
...
linear_svm3 =  LinearSVR(C=1e08,fit_intercept = True, dual = False ,
                        epsilon = 1e-6, loss = 'squared_epsilon_insensitive',
                        max_iter = 10000, random_state = None, verbose = 0).fit(np.array(yawRC), np.array(nR))

coefLinear3 = linear_svm3.coef_

linear_svm3_ramp =  LinearSVR(C=1e04,fit_intercept = True, dual = True ,
                        epsilon = 1e-6, loss = 'squared_epsilon_insensitive',
...
sway_hydrodynamic_derivatives = ['Y`v','Y`r','Y`ð','Y`vvv','Y`ððð']

yaw_hydrodynamic_derivatives = ['N`v','N`r',
                                'N`ð','N`vvv','N`ððð']
